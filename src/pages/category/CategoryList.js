...
const CategoryList = ({ title, filterKey, filterValue, fetchApi }) => {
  ...
  const filteredData = scrollData?.filter(
    (data) => data[filterKey] === filterValue
  );
